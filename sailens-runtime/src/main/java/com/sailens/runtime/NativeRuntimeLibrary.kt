...
internal object NativeRuntimeLibrary {
    const val NAME = "sailens_runtime"
     ...
     *
     * The library binds its methods in `JNI_OnLoad` (see `sailens-runtime/src/main/cpp/sailens_runtime_jni.cpp`),
     * so a class, method or signature mismatch fails the whole load rather than leaving a single
