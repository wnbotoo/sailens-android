...
import com.sailens.guidance.model.common.ZoneMode
...
data class PerceptionConfig(
    ...
    /** 语义障碍（BASIC 挡位）的最小面积，占相机画面。面积等效：原 0.005 x letterbox mask 面积。 */
    ...
    /** 面积等效：原 0.35 x letterbox mask 面积（mask 现在只覆盖相机画面，见 AnalysisConfig）。 */
