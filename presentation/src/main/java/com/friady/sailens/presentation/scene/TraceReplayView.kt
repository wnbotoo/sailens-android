...
private fun TraceReplayReportDetail(
    ...
    Surface(
        ...
        Column(
            ...
            TraceMetricLine(stringResource(R.string.trace_report_semantic_runs, report.semanticRunCount, report.semanticRunFps, report.semanticModelFps))
            TraceMetricLine(stringResource(R.string.trace_report_instance_runs, report.instanceRunCount, report.instanceRunFps, report.instanceModelFps))
            TraceMetricLine(stringResource(R.string.trace_report_mask_render, report.maskRenderCount, report.overlayRenderCount, report.maskRenderFps, report.avgMaskRenderMs))
